      ...
      <section id="main">
        ...
        if(pg_num_rows($result)> 0)
        {
            ...
            while($row= pg_fetch_array($result)){
                ...
                //Imprime el OG
                echo "<TR>
                    <TH >$row[id_oeg]: $row[descripcionoeg]</TD>
                      </TR>";
                ...
                while($row1= pg_fetch_array($result1)){
                    ...
                    $sql2 = "SELECT calificacion, location, dispositivo, fecha FROM historial, caso, objetoaprendizaje
                    ...
                    if($result2==FALSE){
						...
						while($row2= pg_fetch_array($result2)){
							...
							if(empty($row2['calificacion']))
							{
								
							}
							else
							{
								echo "<TD align=center>Disp: $row2[dispositivo] <BR/>Cal: $row2[calificacion]<BR/>F: $row2[fecha]</TD>
                                  ";
							}
						}
						echo "</TR>";
