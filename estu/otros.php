                ...
                <form id="forml-prod" name="forml-prod" method="post" action="../estu/miperfil.php">
                    ...
                    <?php 
                        $conexion = pg_connect("host='localhost' dbname='cursos_rbc' user='postgres' password='%froac$'");
                         ...
                         echo "<a href=http://froac.manizales.unal.edu.co/froac/>FROAC</a>";
						 echo "</br><a href=http://www.colombiaaprende.edu.co/html/home/1592/w3-channel.html>Colombia aprende</a>";
						 echo "</br><a href=https://www.educamaisbrasil.com.br/>Educa Brasil</a>";
