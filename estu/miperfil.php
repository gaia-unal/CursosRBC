      ...
      <section id="main">
        ...
        <section id="contenido">
            <div id="consulta">
                ...
                <form id="forml-prod" name="forml-prod" method="post" action="../estu/miperfil.php">
                    ...
                    <?php 
                        ...
                        $sql = "SELECT *FROM estudiante where estudiante.id_estudiante ='$nombre'";
                        $result = pg_query($sql);
                        ...
                        if($result==FALSE){
                         ...
                         echo "Nombre: $row[nombre]<br>Email: $row[email] <br> Género: $row[genero] <br> Idioma: $row[idiomapreferencia]";
						 echo "<br><br>Estilo de Aprendizaje<br>";
						 echo "<br>Activo - reflexivo: $row[activoreflexivo]";
						 echo "<br>Sensorial - intuitivo: $row[sensorialintuitivo]";
						 echo "<br>Visual - Verbal: $row[visualverbal]";
						 echo "<br>Secuencial - Global: $row[secuencialglobal]";
                        }
                        @pg_close($conexion);?>
                    <br/>
                    <br/>
               <!--     <button type="submit" name="mostrar" id="mostrar">Editar</button> -->
                    </form>
                    </section>
                
                <section id="form-producto">
                <form id="forml-prod" name="forml-prod" method="post" action="../estu/test.php">
                    <p>Evaluar estilo de aprendizaje</p>
                    <br/>
                    <button type="submit" name="mostrar" id="mostrar">Iniciar</button>
                    </form>
                    </section>
                            <hr/>
                    </div>
