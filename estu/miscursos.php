        ...
        <section id="contenido">
            <div id="consulta">
                ...
                <form id="forml-prod" name="forml-prod" method="post" action="../estu/plancurso.php">
                    <p>Seleccione el curso al que desea ingresar:</p>
                    <?php 
                    ...
                    <br/>
                    <br/>
                    <button type="submit" name="mostrar" id="mostrar">Ir al Curso</button>
                    </form>
                    </section>
                
                <section id="form-producto">
                <form id="forml-prod" name="forml-prod" method="post" action="../estu/nuevocurso.php">
                    <p>Si desea registrarse a un nuevo curso haga clic en el siguiente botón:</p>
                    <br/>
                    <button type="submit" name="mostrar" id="mostrar">Nuevo Curso</button>
                    </form>
                    </section>
                            <hr/>
                    </div>
