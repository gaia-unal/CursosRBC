...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/stylesheeterror2.css">
...
<body>
	...
	<section id="wrap">
            ...
            <section id="contenido">
                ...
                <a href="home.html"><img src="images/demo-images/thumb1.jpg"></img></a>
            </section>
                ...
                <form id="forml" name="forml" method="post" action="registro.php">
                    <h3>Regístrate</h3><br>
                    	<div class="input">
                         ...
                         <p id="error">Tu correo electronico debetener mas de 4 caracteres.</p>
                    <br>
