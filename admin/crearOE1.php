      ...
      <section id="main">
        ...
        <section id="contenido">
            <div id="consulta">
                ...
                <form id="forml-prod" name="forml-prod" method="post" action="../admin/crearOE2.php">
                    ...
                    <?php 
						...
						else
						{
							...
							$sql = "SELECT curso.descripcion as descripcion FROM curso WHERE id_curso='$_POST[curso]'";
							$result = pg_query($sql);
							...
							else
							{
								...
								echo "Seleccione el Objetivo General<br/><br/>";
							}
							
							$sqltemp = "SELECT id_oe FROM cursoobjetivo WHERE id_curso='$_POST[curso]' AND partede=' '";
							$resulttemp = pg_query($sqltemp);
							if($resulttemp==FALSE){
								echo "<br> Hay errores en la consulta SQL max caso";
							}
							 echo "<SELECT id=og name=og required=required>
									<OPTION value= >-- Seleccione -- </OPTION>";
							while($rowtemp= pg_fetch_array($resulttemp)){
								
								echo "id_oe:  '$rowtemp[id_oe]'<br/>";
								echo "<OPTION value=$rowtemp[id_oe]>$rowtemp[id_oe]</OPTION>";
							}
							echo "</SELECT> <input id=t_id_curso name=t_id_curso type=hidden  value='$_POST[curso]'/>";
