    ...
    <section id="main">
        ...
        <section id="contenido">
            ...
            <div id="consulta">
				...
				<form id="forml-prod1" name="forml-prod1" method="post" action="crearCurso.php">
				<BR/>
							<button type="submit" name="mostrar" id="mostrar" size="50">Crear curso</button> 
				</form>
				<form id="forml-prod2" name="forml-prod2" method="post" action="crearOG.php">
				<BR/>
							<button type="submit" name="mostrar" id="mostrar" size="50">Crear Obj.General</button>
				</form>
				<form id="forml-prod3" name="forml-prod3" method="post" action="crearOE.php">
				<BR/>
							<button type="submit" name="mostrar" id="mostrar" size="70">Crear Obj.Especifico</button>
				</form>
