      ...
      <section id="main">
        ...
        <section id="contenido">
            <div id="consulta">
                ...
                <form id="forml-prod" name="forml-prod" method="post" action="../admin/guardarOG.php">
                    ...
                    <?php 
						...
						//	echo "<br> no funciona bien: '$_POST[curso]'";
							...
							while($row= pg_fetch_array($result))	
							{
								...
								<input id=t_id_curso name=t_id_curso type=hidden  value='$_POST[curso]'/>
								<table width=100%>
									<tr>
									<td colspan=2>
										<input id=des_og1 name=des_og1 type=text placeholder=Descripción O. General size=70 required=required/>
									</td>
									</tr>
								</table>
								<br/>
								<br/>
								<button type=submit name=mostrar id=mostrar>Guardar Obj. General</button> ";
						}
						  @pg_close($conexion);?>
                    </form>
                    </section>
