...
<body>
    ...
    <section id="main">
        ...
        <section id="contenido">
            ...
            <div id="consulta">
                <h3>Crear Objetivos Generales</h3>
                <section id="form-producto">
				<form id="forml-prod" name="forml-prod" method="post" action="crearOG1.php">
				  ...
				  <?php 
                        ...
                        echo "<SELECT id=curso name=curso onChange=crearOG2.php required=required>
