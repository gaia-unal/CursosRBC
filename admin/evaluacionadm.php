  ...
  <section id ="wrap">
      <section id="main">
        ...
        <div id="consulta">
                ...
                <form id="forml-prod" name="forml-prod" method="post" action="../admin/plancursoadm.php">
                    <table width="100%">
                    <br/>
                    <br/>
                <?php 
                ...
                while($row= pg_fetch_array($result))	{
                    ...
                    <input type='radio' name='eval' value='a' disabled><b>a) </b>$row[a] <br/>
                    <input type='radio' name='eval' value='b' disabled><b>b) </b>$row[b] <br/>
                    <input type='radio' name='eval' value='c' disabled><b>c) </b>$row[c] <br/>
                    <input type='radio' name='eval' value='d' disabled><b>d) </b>$row[d] <br/>
                ...
                <button type="submit" name="mostrar" id="mostrar">Regresar</button>
                </form>
                </section>
                </div>
